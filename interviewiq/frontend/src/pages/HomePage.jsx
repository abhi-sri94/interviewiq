...
function HomePage() {
    ...
    return (
        <div className="min-h-screen bg-[#020617] text-white overflow-hidden">
            ...
            {/* Hero Section */}
            <section className="relative flex flex-col items-center justify-center text-center px-4 pt-16 md:pt-28">
            ...
            {/* Features Section */}
            < section className="px-4 md:px-8 py-12 md:py-28 max-w-7xl mx-auto" >
                ...
                <div className="text-center mb-10 md:mb-20">
                    ...
                    <p className="text-slate-400 mt-4 md:mt-6 text-base md:text-lg max-w-2xl mx-auto">
            ...
            {/* How It Works */}
            < section id="how-it-works" className="px-4 md:px-8 py-12 md:py-28 bg-slate-950/40" >
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10">
                        ...
                        <div className="relative bg-slate-900 border border-slate-800 rounded-2xl md:rounded-3xl p-6 md:p-10">
                            ...
                            <h3 className="text-2xl md:text-3xl font-bold mt-4 md:mt-8 mb-4 md:mb-6">
                                Choose Role
                            </h3>
            ...
            {/* CTA Section */}
            < section className="px-4 md:px-8 py-12 md:py-32" >

                <div className="max-w-5xl mx-auto">

                    <div className="relative overflow-hidden bg-gradient-to-r from-cyan-500/20 to-blue-500/20 border border-cyan-500/20 rounded-2xl md:rounded-[40px] p-6 md:p-16 text-center backdrop-blur-xl">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-slate-300 text-base md:text-xl mt-6 md:mt-8 max-w-2xl mx-auto leading-relaxed">
                                Practice smarter with AI-powered mock interviews,
                                instant feedback, and role-specific preparation.
                            </p>

                            <div className="flex flex-col md:flex-row justify-center gap-3 md:gap-6 mt-8 md:mt-12">

                                <Link to={user ? "/dashboard/interview" : "/login"} state={{ role: selectedRole }} className="w-full md:w-auto">
                                    <button className="w-full bg-cyan-500 hover:bg-cyan-600 transition-all duration-300 px-6 py-3 md:px-10 md:py-5 rounded-xl md:rounded-2xl text-base md:text-lg font-bold shadow-lg shadow-cyan-500/30">
                                        Start Free
                                    </button>
                                </Link>
                                ...
                                <button
                                    onClick={() => document.getElementById('how-it-works')?.scrollIntoView({ behavior: 'smooth' })}
                                    className="w-full md:w-auto border border-slate-500 hover:border-cyan-400 hover:text-cyan-400 transition-all duration-300 px-6 py-3 md:px-10 md:py-5 rounded-xl md:rounded-2xl text-base md:text-lg font-bold"
                                >
                                    Learn More
                                </button>
